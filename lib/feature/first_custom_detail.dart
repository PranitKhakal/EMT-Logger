...
class FirstCustomDetail extends StatefulWidget {
  final String timestamp; // Define a parameter to receive the timestamp

  // Constructor to receive the timestamp
  FirstCustomDetail({required this.timestamp});

  @override
  _FirstCustomDetailState createState() => _FirstCustomDetailState();
}

class _FirstCustomDetailState extends State<FirstCustomDetail> {
