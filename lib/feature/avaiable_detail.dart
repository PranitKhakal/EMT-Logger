...
class AvailableDetail extends StatefulWidget {
  final String timestamp; // Define a parameter to receive the timestamp

  // Constructor to receive the timestamp
  AvailableDetail({required this.timestamp});

  @override
  _AvailableDetailState createState() => _AvailableDetailState();
}

class _AvailableDetailState extends State<AvailableDetail> {
