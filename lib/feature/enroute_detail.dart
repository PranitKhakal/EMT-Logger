...
class EnRouteDetail extends StatefulWidget {
  final String timestamp; // Define a parameter to receive the timestamp

  // Constructor to receive the timestamp
  EnRouteDetail({required this.timestamp});

  @override
  _EnRouteDetailState createState() => _EnRouteDetailState();

}

class _EnRouteDetailState extends State<EnRouteDetail> {
