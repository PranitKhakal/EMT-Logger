...
class AcknowledgmentDetail extends StatefulWidget {
  final String timestamp; // Define a parameter to receive the timestamp

  // Constructor to receive the timestamp
  AcknowledgmentDetail({required this.timestamp});

  @override
  _AcknowledgmentDetailState createState() => _AcknowledgmentDetailState();
}

class _AcknowledgmentDetailState extends State<AcknowledgmentDetail> {
