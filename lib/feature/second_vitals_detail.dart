...
class SecondVitalsDetail extends StatefulWidget {
  final String timestamp; // Define a parameter to receive the timestamp

  // Constructor to receive the timestamp
  SecondVitalsDetail({required this.timestamp});

  @override
  _SecondVitalsDetailState createState() => _SecondVitalsDetailState();
}

class _SecondVitalsDetailState extends State<SecondVitalsDetail> {
