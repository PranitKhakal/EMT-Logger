...
class PtTransferredDetail extends StatefulWidget {
  final String timestamp; // Define a parameter to receive the timestamp

  // Constructor to receive the timestamp
  PtTransferredDetail({required this.timestamp});

  @override
  _PtTransferredDetailState createState() => _PtTransferredDetailState();
}

class _PtTransferredDetailState extends State<PtTransferredDetail> {
