...
class FirstVitalsDetail extends StatefulWidget {
  final String timestamp; // Define a parameter to receive the timestamp

  // Constructor to receive the timestamp
  FirstVitalsDetail({required this.timestamp});

  @override
  _FirstVitalsDetailState createState() => _FirstVitalsDetailState();
}

class _FirstVitalsDetailState extends State<FirstVitalsDetail> {
