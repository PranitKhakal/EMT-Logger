...
class SecondCustomDetail extends StatefulWidget {
  final String timestamp; // Define a parameter to receive the timestamp

  // Constructor to receive the timestamp
  SecondCustomDetail({required this.timestamp});

  @override
  _SecondCustomDetailState createState() => _SecondCustomDetailState();
}

class _SecondCustomDetailState extends State<SecondCustomDetail> {
